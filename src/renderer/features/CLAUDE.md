...
This directory contains older renderer-local slices and integrations. **Do not add new cross-process features here.**
...
- [`src/features/agent-graph/`](../../features/agent-graph)
