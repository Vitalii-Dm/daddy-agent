...
export const ChipInteractionLayer = ({
  ...
  // revealFileInEditor / revealFolderInEditor: editor slice removed — no-op stubs
  const revealFileInEditor = (_filePath: string): void => {};
  const revealFolderInEditor = (_folderPath: string): void => {};
